...
public class DatesTest {
    ...
    @Test
    void toDate_NullGiven_ShouldReturnNull() throws Exception {
    ...
    @Test
    void toDate_ValidStringGiven_ShouldReturnLocalDate() throws Exception {
    ...
    void toDate_InvalidStringGiven_ShouldThrowEx() {
        assertThrows(ParseException.class, () -> Dates.toDate("30.2.11", "dd.MM.yyyy"));
    }

    @Test
    void toDate_NullAsPatternGiven_ShouldThrowEx() {
        assertThrows(NullPointerException.class, () -> Dates.toDate("30.2.11", null));
    }
    ...
    void toString_NullAsPatternGiven_ShouldThrowEx() {
        assertThrows(NullPointerException.class, () -> Dates.toString(new Date(), null));
        assertThrows(NullPointerException.class, () -> Dates.toString(LocalDate.now(), null));
        assertThrows(NullPointerException.class, () -> Dates.toString(LocalDateTime.now(), null));
    }
    ...
    @Test
    void toXmlGregorianCalendar_NullDateGiven_ShouldReturnNull() throws Exception {
        assertNull(Dates.toXmlGregorianCalendar((Date)null));
    }

    @Test
    void toXmlGregorianCalendar_NullLocalDateTimeGiven_ShouldReturnNull() throws Exception {
        assertNull(Dates.toXmlGregorianCalendar((LocalDateTime) null));
    }

    @Test
    void toXmlGregorianCalendar_DateGiven_ShouldReturnString() throws Exception {
        Date date = new Date();
